...
public class EvaluationController {
  ...
  @PutMapping("/evaluation/{evaluation_id}")//평가 수정 API
  @Operation(summary = "평가 수정", description = "동아리 회원이 지원자를 보고 남긴 평가를 수정한다.", responses = {
  ...
  public ResponseEntity updateEvaluation(@Validated @RequestBody EvaluationUpdateRequest evaluationUpdateRequest, @Validated @PathVariable(name = "evaluation_id") Long evaluationId, @Auth Long memberId){
  ...
  @DeleteMapping("/evaluation/{evaluation_id}")//평가 삭제 API
  @Operation(summary = "평가 삭제", description = "동아리 회원이 지원자를 보고 남긴 평가를 삭제한다.", responses = {
  ...
  public ResponseEntity deleteEvaluation(@Validated @PathVariable(name = "evaluation_id") Long evaluationId,@Auth Long memberId){
